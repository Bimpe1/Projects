 ...
 * @author adeto
 */
public class webcam6 extends javax.swing.JFrame {
    static{
...
private void CaptureImage(JLabel image){
    try{
        stopCam();
        if(getImage != null){
            ImageIcon imageicon =new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(inventorymanager.jLabel18.getWidth(),
                    inventorymanager.jLabel18.getHeight(), Image.SCALE_DEFAULT));
            inventorymanager.jLabel18.setIcon(imageicon);
        }
    }catch(Exception e){
...
if(option ==0){
    try{
        ...
        inventorymanager.jTextField9.setText(Filename);
        ...
        inventorymanager.photo =baos.toByteArray();
        dispose();
    }catch(Exception e){
        stopCam();
        JOptionPane.showMessageDialog(rootPane," Warning");
...
inventorymanager jfrm2=new inventorymanager(email);
jfrm2.show();
dispose();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(webcam6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
