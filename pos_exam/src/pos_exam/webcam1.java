...
private void CaptureImage(JLabel image){
    try{
        stopCam();
        if(getImage != null){
            ImageIcon imageicon =new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(home.jLabel10.getWidth(),
                    home.jLabel10.getHeight(), Image.SCALE_DEFAULT));
            home.jLabel10.setIcon(imageicon);
        }
    }catch(Exception e){
...
if(option ==0){
    try{
        ...
        home.jTextField8.setText(Filename);
