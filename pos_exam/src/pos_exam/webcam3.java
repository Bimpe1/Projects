 ...
 * @author adeto
 */
public class webcam3 extends javax.swing.JFrame {
    static{
...
private void CaptureImage(JLabel image){
    try{
        stopCam();
        if(getImage != null){
            ImageIcon imageicon =new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(inventory.jLabel20.getWidth(),
                    inventory.jLabel20.getHeight(), Image.SCALE_DEFAULT));
            inventory.jLabel20.setIcon(imageicon);
        }
    }catch(Exception e){
...
if(option ==0){
    try{
        ...
        inventory.jTextField9.setText(Filename);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(webcam3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
