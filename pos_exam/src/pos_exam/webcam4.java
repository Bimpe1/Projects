 ...
 * @author adeto
 */
public class webcam4 extends javax.swing.JFrame {
    static{
...
private void CaptureImage(JLabel image){
    try{
        stopCam();
        if(getImage != null){
            ImageIcon imageicon =new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(inventory.jLabel21.getWidth(),
                    inventory.jLabel21.getHeight(), Image.SCALE_DEFAULT));
            inventory.jLabel21.setIcon(imageicon);
        }
    }catch(Exception e){
...
if(option ==0){
    try{
        ...
        inventory.jTextField10.setText(Filename);
        ...
        inventory.photo =baos.toByteArray();
        dispose();
    }catch(Exception e){
        stopCam();
        JOptionPane.showMessageDialog(rootPane," Warning");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(webcam4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
