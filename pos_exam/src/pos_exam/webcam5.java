 ...
 * @author adeto
 */
public class webcam5 extends javax.swing.JFrame {
    static{
...
private void CaptureImage(JLabel image){
    try{
        stopCam();
        if(getImage != null){
            ImageIcon imageicon =new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(inventorymanager.jLabel21.getWidth(),
                    inventorymanager.jLabel21.getHeight(), Image.SCALE_DEFAULT));
            inventorymanager.jLabel21.setIcon(imageicon);
        }
    }catch(Exception e){
...
if(option ==0){
    try{
        ...
        inventorymanager.jTextField10.setText(Filename);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(webcam5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
